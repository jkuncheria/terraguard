...
const ESDConductive: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <ServiceSchema
        serviceName="ESD & Conductive Flooring Installation"
        serviceType="ESD Flooring"
        description="Static-dissipative and conductive flooring for electronics manufacturing, aerospace, and data centers. ANSI/ESD compliant flooring solutions."
        url="/esd-conductive"
        image="/images/flooring/esd-conductive.png"
      />
            ...
            <div className="hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl">
                <img 
                  ...
                  alt="ESD conductive flooring for electronics manufacturing in Arizona by TerraGuard"
                  loading="lazy"
