...
import { CheckCircle, Factory, Shield, Truck, Wrench } from 'lucide-react';

const Manufacturing: React.FC = () => {
  const seo = SEO_CONFIG.pages.manufacturing;

  const features = [
    {
      icon: <Shield className="w-8 h-8 text-blue-900" />,
      title: 'Impact Resistant',
      description: 'Withstands heavy machinery, dropped tools, and constant forklift traffic.',
    },
    {
      icon: <Factory className="w-8 h-8 text-blue-900" />,
      title: 'Chemical Resistant',
      description: 'Resists industrial chemicals, solvents, and cleaning agents.',
    },
    {
      icon: <Truck className="w-8 h-8 text-blue-900" />,
      title: 'Forklift Rated',
      description: 'Engineered to handle heavy wheeled traffic without damage.',
    },
    {
      icon: <Wrench className="w-8 h-8 text-blue-900" />,
      title: 'Low Maintenance',
      description: 'Seamless surfaces are easy to clean and maintain.',
    },
  ];
    ...
    <>
      ...
      <section className="py-16 px-4 md:px-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Built for Industrial Demands</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our flooring systems are engineered to handle the toughest manufacturing environments.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link to="/epoxy-flooring" className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition group">
              ...
              <p className="text-gray-600 mb-4">
                Versatile, cost-effective solution for general manufacturing and warehouse floors.
              </p>
            ...
            <Link to="/urethane-cement" className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition group">
              ...
              <p className="text-gray-600 mb-4">
                Heavy-duty option for extreme conditions and heavy impact areas.
              </p>
              <ul className="space-y-2 text-gray-700 text-sm">
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-600 mr-2" />
            ...
            <Link to="/polished-concrete" className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition group">
              ...
              <p className="text-gray-600 mb-4">
                Economical solution for warehouses and distribution centers.
              </p>
              <ul className="space-y-2 text-gray-700 text-sm">
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-600 mr-2" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                TerraGuard provides flooring solutions for manufacturing facilities of all sizes throughout Arizona.
              </p>
      ...
      <section className="py-16 px-4 md:px-16 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Ready for Industrial-Grade Flooring?</h2>
          <p className="text-xl text-gray-300 mb-8">
            Contact TerraGuard for a consultation on flooring solutions for your manufacturing facility.
          </p>
          <Link
            to="/contact"
